...
void control_temperatura(float T) {
    ...
    if (!calentador_on && T < 24.0) { LATDbits.LATD0 = 1; calentador_on = 1; }
    else if (calentador_on && T > 30.0) { LATDbits.LATD0 = 0; calentador_on = 0; }
}
...
void control_aire(int aire) {
    if (aire > 700) {
        ...
        if (contador_aire > 3) {
            unsigned char i;
            for (i = 0; i < 200; i++) {
                LATDbits.LATD3 = 1; _delay((unsigned long)((500)*(8000000/4000000.0)));
                LATDbits.LATD3 = 0; _delay((unsigned long)((500)*(8000000/4000000.0)));
            }
        }
    } else {
        contador_aire = 0;
