...
if(!calentador_on && T < 20) { LATDbits.LATD0 = 1; calentador_on = 1; }
else if(calentador_on && T > 24) { LATDbits.LATD0 = 0; calentador_on = 0; }
}

void control_luz(int luz)
{
static int led_on = 0;
if(!led_on && luz < 450) { LATDbits.LATD2 = 1; led_on = 1; }
else if(led_on && luz > 550) { LATDbits.LATD2 = 0; led_on = 0; }
}
